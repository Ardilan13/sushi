...
$cantidad_merma = $cantidad - ((float)$cantidad * (float)$row['merma']) / 100;
...
$crear_compra = "INSERT INTO compra(id_producto, fecha, cantidad, precio) VALUES ($producto,'$fecha',$cantidad_merma,$precio);";
